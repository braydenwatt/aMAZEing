...
execute if entity @e[tag=maze_next] as @e[tag=active_marker] at @s run setblock ~ ~ ~ blue_concrete
execute if entity @e[tag=maze_next] as @e[tag=active_marker] at @s anchored feet facing entity @e[tag=maze_next,limit=1] feet run setblock ^ ^ ^1 blue_concrete
...
execute unless entity @e[tag=maze_next] as @e[tag=active_marker] at @s run setblock ~ ~ ~ white_concrete
...
execute unless entity @e[tag=maze_next] if entity @e[tag=last_marker] as @e[tag=active_marker] at @s anchored feet facing entity @e[tag=last_marker,limit=1] feet run setblock ^ ^ ^1 white_concrete
