...
execute if data storage maze building as @e[tag=maze_flood_active] at @s run fill ~-1 ~ ~-1 ~1 ~ ~1 minecraft:structure_block[mode=load]{ignoreEntities:1b,integrity:1.0f,mode:"LOAD",name:"mazegen:maze_path",posX:0,posY:0,posZ:0,sizeX:1,sizeY:10,sizeZ:1} replace white_concrete
execute if data storage maze building as @e[tag=maze_flood_active] at @s run fill ~-1 ~ ~-1 ~1 ~ ~1 minecraft:structure_block[mode=load]{ignoreEntities:1b,integrity:1.0f,mode:"LOAD",name:"mazegen:maze_path",posX:0,posY:0,posZ:0,sizeX:1,sizeY:10,sizeZ:1} replace blue_concrete
execute if data storage maze building as @e[tag=maze_flood_active] at @s run fill ~-1 ~ ~-1 ~1 ~ ~1 minecraft:structure_block[mode=load]{ignoreEntities:1b,integrity:1.0f,mode:"LOAD",name:"mazegen:maze_path",posX:0,posY:0,posZ:0,sizeX:1,sizeY:10,sizeZ:1} replace yellow_concrete
execute if data storage maze building as @e[tag=maze_flood_active] at @s run fill ~-1 ~ ~-1 ~1 ~ ~1 minecraft:structure_block[mode=load]{ignoreEntities:1b,integrity:1.0f,mode:"LOAD",name:"mazegen:maze_path",posX:0,posY:0,posZ:0,sizeX:1,sizeY:10,sizeZ:1} replace light_blue_concrete
