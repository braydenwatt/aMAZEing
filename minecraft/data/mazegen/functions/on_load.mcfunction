...
scoreboard objectives add maze_end_x dummy
scoreboard objectives add maze_end_y dummy
scoreboard objectives add maze_curr_x dummy
scoreboard objectives add maze_curr_y dummy